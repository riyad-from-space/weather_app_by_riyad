...
final weatherViewModelProvider =
    FutureProvider.family<WeatherResponse, String>((ref, cityName) {
  final repository = ref.read(weatherRepositoryProvider);
  return repository.fetchWeather(cityName);
});

final forecastProvider =
    FutureProvider.family<ForecastResponse, String>((ref, cityName) {
  final repository = ref.read(weatherRepositoryProvider);
  return repository.fetchForecast(cityName);
});
